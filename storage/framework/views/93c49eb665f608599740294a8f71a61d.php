...
<div class="min-h-screen flex items-center justify-center p-4 lg:p-8">
    <div class="w-full max-w-4xl bg-white rounded-3xl shadow-xl overflow-hidden grid lg:grid-cols-2">
        ...
        <div class="hidden lg:flex flex-col justify-between bg-gradient-to-br from-indigo-600 via-violet-600 to-fuchsia-600 p-10 text-white relative overflow-hidden">
            ...
            <a href="<?php echo e(url('/')); ?>" class="flex items-center gap-2.5 relative z-10">
        ...
        <div class="p-8 sm:p-12 flex flex-col justify-center">
            ...
            <form method="POST" action="<?php echo e(route('login.post')); ?>" class="space-y-4">
                ...
                <div>
                    ...
                    <input type="email" name="email" class="input" value="<?php echo e(old('email')); ?>" placeholder="vous@exemple.com" required autofocus>
                </div>
            ...
            <p class="text-center mt-6 text-gray-500 text-sm">
                Pas encore de compte ? <a href="<?php echo e(route('register')); ?>" class="text-indigo-600 font-semibold hover:underline">Créer mon dossier</a>
            </p>
        </div>
    </div>
</div>
...
<?php echo $__env->make('layouts.guest', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\1996\Downloads\sante-portable-hardened\sante-portable\resources\views/auth/login.blade.php ENDPATH**/ ?>