    ...
    <div class="max-w-6xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div class="flex items-center gap-3">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="btn-primary text-sm">Mon tableau de bord →</a>
            <?php else: ?>
                <a href="<?php echo e(route('login')); ?>" class="btn-secondary text-sm">Se connecter</a>
                <a href="<?php echo e(route('register')); ?>" class="btn-primary text-sm">Créer mon dossier</a>
            <?php endif; ?>
        </div>
    </div>
</nav>
...
<section class="relative overflow-hidden bg-gradient-to-b from-indigo-50/60 via-white to-white px-4 pt-16 pb-20">
    <div class="relative max-w-4xl mx-auto text-center">
        ...
        <div class="flex gap-3 justify-center flex-wrap mb-10">
            <?php if(auth()->guard()->check()): ?>
                <a href="<?php echo e(route('dashboard')); ?>" class="btn-primary text-base px-7 py-3.5">Mon tableau de bord →</a>
            <?php else: ?>
                <a href="<?php echo e(route('register')); ?>" class="btn-primary text-base px-7 py-3.5">Créer mon dossier gratuit</a>
                <a href="<?php echo e(route('login')); ?>" class="btn-secondary text-base px-7 py-3.5">Se connecter</a>
            <?php endif; ?>
        </div>
...
<section class="max-w-3xl mx-auto text-center px-4 py-20">
    ...
    <?php if(auth()->guard()->guest()): ?>
        <a href="<?php echo e(route('register')); ?>" class="btn-primary text-base px-8 py-4 inline-block">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\1996\Downloads\sante-portable-hardened\sante-portable\resources\views/welcome.blade.php ENDPATH**/ ?>